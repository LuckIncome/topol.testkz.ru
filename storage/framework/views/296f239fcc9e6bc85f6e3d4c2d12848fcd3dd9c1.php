<ul class="<?php echo e(!isset($isParent) ? 'nav navbar-nav hamb-menu' : 'dropdown-menu'); ?>">
    <?php
    ...
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(!in_array(class_basename($originalItem) ,['Page','Category'])): ?>
            <li class="nav-item <?php echo e($isActive); ?> <?php echo e(($originalItem->hasPage || !$originalItem->children->isEmpty()) ? 'dropdown':''); ?>">
                <a href="<?php echo e($originalItem->hasPage ? '#' : url($originalItem->link())); ?>" target="<?php echo e($originalItem->target); ?>" style="<?php echo e($styles); ?>">
...
<?php /**PATH /var/www/vhosts/topol.kz/httpdocs/resources/views/vendor/voyager/menu/default-m.blade.php ENDPATH**/ ?>