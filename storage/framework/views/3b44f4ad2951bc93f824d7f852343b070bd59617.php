    ...
    <div class="page posts sales-page">
        <div class="content-sidebar">
            ...
            <div class="content col-9">
                <div class="items">
                    <?php if($sales->count()): ?>
                        <?php $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="item img-hover">
                                ...
                                <div class="text">
                                    <p class="date"><?php echo e($post->getTranslatedAttribute('period',$locale,$fallbackLocale)); ?></p>
...
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/topol.kz/httpdocs/resources/views/sales/index.blade.php ENDPATH**/ ?>