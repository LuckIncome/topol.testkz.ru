...
<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <li class="<?php echo e($listItemClass); ?>">
        <a href="<?php echo e(url($item->link())); ?>" target="<?php echo e($item->target); ?>" style="<?php echo e($styles); ?>" <?php echo $linkAttributes ?? ''; ?>>
            <?php echo $icon; ?>
...
<?php /**PATH /var/www/vhosts/topol.kz/httpdocs/vendor/tcg/voyager/resources/views/menu/bootstrap.blade.php ENDPATH**/ ?>