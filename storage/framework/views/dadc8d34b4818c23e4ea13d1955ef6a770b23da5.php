...
<div id="coordinates-formfield">
    <coordinates
        inline-template
        ref="coordinates"
        api-key="<?php echo e(config('voyager.googlemaps.key')); ?>"
        :points='<?php echo json_encode($dataTypeContent->getCoordinates() && count($dataTypeContent->getCoordinates()) ? $dataTypeContent->getCoordinates() : [[ 'lat' => config('voyager.googlemaps.center.lat'), 'lng' => config('voyager.googlemaps.center.lng') ]], 512) ?>'
        :show-autocomplete="<?php echo e($showAutocomplete); ?>"
        :show-lat-lng="<?php echo e($showLatLng); ?>"
        ...
        <div>
            <div class="form-group">
                <div class="col-md-5" v-if="showAutocomplete">
                    <label class="control-label"><?php echo e(__('voyager::generic.find_by_place')); ?></label>
                    <input
                        class="form-control"
                        type="text"
                ...
                <div class="col-md-2" v-if="showLatLng">
                    <label class="control-label"><?php echo e(__('voyager::generic.latitude')); ?></label>
                    <input
                        class="form-control"
                        type="number"
                        step="any"
                        name="<?php echo e($row->field); ?>[lat]"
                        placeholder="19.6400"
                        v-model="lat"
                ...
                <div class="col-md-2" v-if="showLatLng">
                    <label class="control-label"><?php echo e(__('voyager::generic.longitude')); ?></label>
                    <input
                        class="form-control"
                        type="number"
                        step="any"
                        name="<?php echo e($row->field); ?>[lng]"
        ...
        Vue.component('coordinates', {
            ...
            methods: {
                ...
                onChange: function(eventType) {
                    <?php if(property_exists($row->details, 'onChange')): ?>
                        ...
                        this.onChangeDebounceTimeout = setTimeout(function() {
                            <?php echo e($row->details->onChange); ?>(eventType, {
                                lat: self.lat,
                                lng: self.lng,
                                place: self.place
                            });
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/vhosts/topol.kz/httpdocs/vendor/tcg/voyager/resources/views/formfields/coordinates.blade.php ENDPATH**/ ?>