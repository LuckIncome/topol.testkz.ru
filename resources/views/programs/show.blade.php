...
@section('content')
    <div class="page single-post">
        <div class="content-sidebar">
            <h1>{{$post->title}}</h1>
            @include('partials.breadcrumbs',['title'=>__('general.pageAbout'),'titleLink'=>route('pages.about'),'subtitle'=> __('general.programs'), 'subtitleLink'=> route('programs.index'), 'childTitle'=> $post->title])
